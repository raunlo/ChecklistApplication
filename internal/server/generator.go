...
//go:generate  go tool  github.com/oapi-codegen/oapi-codegen/v2/cmd/oapi-codegen -o ./v1/checklistItem_row/server.gen.go -config ./v1/checklistItem_row/cfg.yaml ./../../openapi/api_v1.yaml
